...
const { applyIntlPolyfill } = require('../util/intl')
...
const { getLoggingContext } = require('../util/logging')

const polyfills = require('../util/polyfills')
...
const elasticsearchReindex = require('../elasticsearch-reindex')
const elasticsearchSync = require('../elasticsearch-sync')
const elasticsearchTemplates = require('../elasticsearch-templates')
